...
## Included Data
For reproducibility, this package includes the FiveThirtyEight dataset discussed in the paper. The ESPN dataset that includes the win probabilities for the NCAA Collegiate Football 2016-2018 season's is included on my github. However, it is not included in the package due to size limitations. 
